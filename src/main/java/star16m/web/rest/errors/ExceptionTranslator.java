package star16m.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(star16m.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        star16m.service.UsernameAlreadyUsedException ex,
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(star16m.service.InvalidPasswordException ex, NativeWebRequest request) {
